...
function removeDeletedItemFromUI(categoryId) {
  ...
  function confirmDelete(categoryId) {
    ...
    deleteButton.addEventListener("click", function (event) {
      ...
      $.ajax({
        url: `/admin/categories/delete-category?id=${categoryId}`,
        type: "DELETE",
  ...
  if (existingCategory) {
      ...
      $.ajax({
        url: "/admin/categories/add-new-category",
        type: "POST",
        data: formData,
        success: function (data) {
          if (data.success) {
  ...
  function editCategory() {
    ...
    fetch("/admin/categories/add-updated-category?categoryId=" + categoryId, {
        method: "POST",
        headers: {
